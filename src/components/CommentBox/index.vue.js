...
function __VLS_template() {
    ...
    var _loop_1 = function (cbValue, cbIndex) {
        ...
        var __VLS_2 = void 0;
        var __VLS_3 = void 0;
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: ("pl-5 border-l-4 border-light-gray dark:border-lightGrayDARK rounded-md") }));
