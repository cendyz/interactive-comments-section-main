...
<template>
	<div
		class="flex items-start gap-x-4 mt-4 p-8 bg-white rounded-xl"
		v-show="props.secondIndex === props.replyCommentIndex && props.mainIndex !== props.replyCommentIndex">
		<img
		...
		<textarea
			id="reply-comment"
			:class="[
				'p-5 w-full rounded-lg text-dark-blue border border-dark-blue min-h-20 max-h-32 overflow-y-scroll outline-none focus:border-moderate-blue',
